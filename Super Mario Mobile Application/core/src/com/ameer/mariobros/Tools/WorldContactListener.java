...
import com.ameer.mariobros.Sprites.Other.FireBall;
import com.ameer.mariobros.Sprites.TileObjects.InteractiveTileObject;
        ...
        switch (cDef){
            ...
            case MarioBros.FIREBALL_BIT | MarioBros.ENEMY_BIT:
                if(fixA.getFilterData().categoryBits == MarioBros.ENEMY_BIT) {
                    ...
                    System.out.println("fireball collide");
                }
                else {
